...
*** Test Cases ***
借款端_注册_登录_预约申请
          Open Browser          https://lo-test.yingu.com/#/register          chrome
          send          {F11}
          Input Text          phone          13311598060
          Click Element          id=send          13072119880303514X          6214850217779898
          \          \          18910135556
          \          \          6225880118455279
          \          \          220323198402123213          cswangzheng          zsdingmin
          \          \          http://www.cnblogs.com/testwang/p/6097621.html
...
金管系统_初审
          ...
          input text          name=user_name          hejun
...
金管系统_终审
          Open Browser          http://10.0.129.210:8091/
          Maximize Browser Window
          input text          name=user_name          zsdingmin
          input text          name=user_pass          1
          Click Button          imageField
          sleep          1
...
借款端绑卡签约
          Open Browser          https://lo-test.yingu.com/#/login          chrome
          Input Text          //*[@id="phone"]          17710181598
          Input Text          //*[@id="password"]          czq123
...
银谷在线出借端
          Comment          银谷在线出借端购买          liushuozai          liu19901130
          Comment          银谷在线出借端购买          jiyingying          jiyingying
          Comment          银谷在线出借端购买          luyanzhu          q12345678
          银谷在线出借端购买          chuzhiqiang          chuzhiqiang
...
金融管理系统上传合同
          ...
          sleep          5
          click element          //*[@id="datagrid-row-r1-1-0"]/td[3]/div/a
          sleep          5
          click element          xpath=/html/body/div[3]/div[2]/div[2]/form/div[2]/div/div[6]/table/tbody/tr[6]/td[5]/object
          sleep          5
          Wait For Active Window          打开
          Control Click          打开          \          Edit1
          send          "D023.png"
          Control Click          打开          \          Button1          #分界岭1
          sleep          5
          Execute Javascript          document.documentElement.scrollTop=500
          click element          //*[@id='qianyuexinxiheshibiao_uploadUploader']
          sleep          5
          Wait For Active Window          打开
          Control Click          打开          \          Edit1
          send          "D023.png"
          Control Click          打开          \          Button1          #分界岭2
          sleep          5
          click element          //*[@id="qitahetongxinxi_uploadUploader"]
          sleep          5
          Wait For Active Window          打开
          Control Click          打开          \          Edit1
          send          "D023.png"
          Control Click          打开          \          Button1          #分界岭3
          sleep          5
          click element          xpath=//*[@id="mianshen_uploadUploader"]
          sleep          5
          Wait For Active Window          打开
          Control Click          打开          \          Edit1
          send          "D015.png" "D014.png"
          Control Click          打开          \          Button1          #分界岭4
          sleep          5
          Click Element          //*[@id='form1']/div[2]/div/div[6]/table/tbody/tr[1]/td/input[1]
          sleep          3
...
运营终审通过
          ...
          click element          xpath=html/body/div[2]/div[2]/a[1]/img
          sleep          3
          Comment          goto          http://10.0.128.112:8089/Normal/Index          HEB1201704060002
          sleep          3
          Click Link          合同审核
          input text          txtName          褚志强
          sleep          5
...
线上放款端转账
          Open Browser          http://172.24.132.69:9090/lo-server/user/home
          Maximize Browser Window
...
自助月还系统
          ...
          Maximize Browser Window
          input text          usernameone          17710181598
...
博客
          Open Browser          http://www.cnblogs.com/alex3714/p/5188179.html

接口自动化
          Open Browser          http://10.0.128.240:9080/page/
          Maximize Browser Window
          input text          idCardNo          150430198707250396
          input text          orderNo          HEB1201703290004
          Click Element          btn
          ${A}          Get Window Identifiers
          LOG          ${A}
...
银谷后台挂标
          ...
          Click Element          //*[@id="tb_departments"]/thead/tr/th[1]/div[1]/input
          sleep          5
          Comment          click element          //*[@id="btn_push"]

银谷在线出借端购买
          [Arguments]          ${UNAME}          ${PWD}
          Open Browser          https://qa01-passport.yingujr.com/sso/login?service=https%3A%2F%2Fqa01-www.yingujr.com%2Fuser%2Fbank
          Maximize Browser Window
